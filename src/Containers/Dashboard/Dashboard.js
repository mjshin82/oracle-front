        ...
        return (
            <div id="Dashboard" className="Dashboard">
                <div className="DashboardDescBox">
                    ...
                    <Message warn>
                        <h5>이게 대체 뭔가요?</h5>
                        5년치가 학습된 Tensorflow를 이용해서 다음날의 코스피와 코스닥 주가를 예측합니다.
                        <h5>어떠한 원리에 의해 예측되나요?</h5>
                        코스피와 코스닥은 미국/ 중국/ 유럽등의 증시에 영향을 많이 받습니다. 전날의 지수와 다음날의 코스피/코스닥 지수관의 상관관계를 Tensorflow가 자동으로 찾아줍니다.
                        <h5>얼마나 정확한가요?</h5>
                        주가를 기반으로 하는 기술적 분석입니다. 때문에 시장의 돌발적인 상황에 대처할 수는 없습니다. 보조 지표로 활용 가능합니다.
                        <h5>다음날 예측은 언제 갱신되나요</h5>
                        전날의 한/미/중/유럽장이 미감되야 예측이 완료됩니다. 그전까지는 현재 지수, 아직 장이 마감되지 않으면 전날의 지수를 기반으로 예측합니다. 장 마감 전까지는 예측율이 떨어집니다. 1시간마다 한번씩 갱신됩니다.
                        <h5>왜 만들었나요?</h5>
